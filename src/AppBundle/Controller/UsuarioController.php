...
class UsuarioController extends Controller
{
    ...
    {
        if ($this->get("security.authorization_checker")->isGranted("ROLE_ASESOR")) {
            return $this->render('AppBundle:Asesor:principala.html.twig');
    ...
    public function PrincipalAsesorAction(Request $request)
    {
        print_r("expression");
    }
